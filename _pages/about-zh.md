...
我的研究主要关注：
- **类脑计算**，重点关注**脉冲神经网络（SNN）**
- **时序与序列建模**，尤其关注认知启发场景和推荐系统场景
- **面向端侧 AI 的高效语音与语言模型**，探索轻量级、低功耗、高性能网络
- **神经/语音信号解码**，包括 EEG、ECG、EMG 以及听觉注意/认知建模

---

### 🤝 合作交流

我希望构建高效、可部署的 AI 系统，将类脑模型、时序序列建模与神经/语音信号理解连接起来。<br>
如果你正在研究 SNN、端侧 AI、推荐系统序列建模、BCI 解码或高效语音/语言模型架构，非常欢迎交流与合作！
